...
// -----------------------------------------------------------------------------
void setupMDNS() {
  const char *hostName = "smartclock";  // your device name
  MDNS.end();
      ...
      <html style="background: radial-gradient(ellipse at 70% 0%, #2b425a 0%, #171e23 100%); height: 100%;">
        ...
        <body>
          ...
          <p>
            ...
            2. Reconnect your PC or phone to the Wi-Fi network: <strong>SmartClock</strong>.<br>
