...
<title>Pengaturan Jam Pintar</title>
<style>
...
<form id="configForm" onsubmit="submitConfig(event)">
  <div class="logo">
    ...
    <svg width="700" height="250" viewBox="0 0 700 280" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <!-- Reveal animation -->
        <mask id="reveal">
  ...
  <select id="timeZone" name="timeZone" required>
    <option value="" disabled selected>Pilih zona waktu Anda</option>
  ...
  <option value="Etc/GMT-1">Etc/GMT-1</option>
    ...
    <label for="language">Bahasa (Hari & Cuaca)</label>
  ...
  <div class="form-row two-col">
    <div>
      ...
      <label class="small">(Detik)</label>
    </div>
    <div>
      <label for="weatherDuration">Durasi Cuaca</label>
  ...
  <h2>Pengaturan Cuaca</h2>
  <label for="openWeatherApiKey">Kunci API OpenWeather</label>
  <input type="text" id="openWeatherApiKey" name="openWeatherApiKey" placeholder="ADD-YOUR-API-KEY-32-CHARACTERS"/>    
  <div class="small">Membutuhkan data cuaca. <a href="https://home.openweathermap.org/users/sign_up" target="_blank">dapatkan kunci API Anda di sini</a>.</div>
  ...
  <button type="button" class="primary-button" id="geo-button" onclick="getLocation()" style="margin-top: 1rem;">Dapatkan Lokasi Saya</button>

  <div class="small">    
    <strong>Contoh format lokasi:</strong> City, Country Code - Osaka, JP | ZIP, Country Code - 94040, US | Latitude, Longitude - 34.6937, 135.5023
  </div>
  
  <div class="form-group">
    <h2>Pesan Kustom</h2>
    <input id="customMessage" name="customMessage" type="text" maxlength="120" placeholder="MASUKKAN PESAN" pattern="[A-Z0-9 :!'\-.,_\+%\/?]*" title="Hanya huruf kapital, angka, spasi, dan : ! ' - . ? , _ + % / ? yang diizinkan">
    <div class="small">Karakter yang diizinkan: A–Z, 0–9, spasi, dan : ! ' - . ? , _ + % /</div>
  </div>
  <div class="button-row">
    <button type="button" class="primary-button cmsg1" onclick="sendCustomMessage()">Kirim Pesan</button>
    <button type="button" class="primary-button cmsg2" onclick="clearCustomMessage()">Hapus Pesan</button>
  </div>     

  <div class="geo-note" style="display: none;">
    <br>
    <span class="small"><strong>Catatan:</strong> Link diluar, Custom Pesan dan Mendapatkan Lokasi Saya Membutuhkan akses internet.</span>
    <span class="small">Tidak bisa berfungsi saat perangkat dalam mode AP - hubungkan ke Wi-Fi terlebih dahulu.</span>
  </div>
  ...
  <div class="collapsible-content" aria-hidden="true">
    <label>NTP Server Utama:</label>
    <input type="text" name="ntpServer1" id="ntpServer1" placeholder="Masukkan NTP Server Utama">

    <label>NTP Server Kedua:</label>
    <input type="text" name="ntpServer2" id="ntpServer2" placeholder="Masukkan NTP Server Kedua">
    <div class="toggles" style="padding: 0 1rem;">
      ...
      <label style="display: flex; align-items: center; margin-top: 1.75rem; justify-content: space-between;">
        <span style="margin-right: 0.5em;">Tunjukkan Hari:</span>
      ...
      <label style="display: flex; align-items: center; margin-top: 1.75rem; justify-content: space-between;">
        <span style="margin-right: 0.5em;">Animasi Detik:</span>
        <span class="toggle-switch">
      ...
      <label style="display: flex; align-items: center; margin-top: 1.75rem; justify-content: space-between;">
        <span style="margin-right: 0.5em;">Tunjukkan Tanggal:</span>
        <span class="toggle-switch">
      ...
      <label style="display: flex; align-items: center; margin-top: 1.75rem; justify-content: space-between;">
        <span style="margin-right: 0.5em;">Tampilkan Jam 12-Jam:</span>
        <span class="toggle-switch">
      ...
      <label style="display: flex; align-items: center; margin-top: 1.75rem; justify-content: space-between;">
        <span style="margin-right: 0.5em;">Gunakan Satuan Imperial (°F):</span>
        <span class="toggle-switch">
      ...
      <label style="display: flex; align-items: center; margin-top: 1.75rem; justify-content: space-between;">
        <span style="margin-right: 0.5em;">Tunjukkan Kelembaban:</span>
        <span class="toggle-switch">
      ...
      <label style="display: flex; align-items: center; margin-top: 1.75rem; justify-content: space-between;">
        <span style="margin-right: 0.5em;">Tunjukkan Deskripsi Cuaca:</span>
        <span class="toggle-switch">
      ...
      <label style="display: flex; align-items: center; margin-top: 1.75rem; justify-content: space-between;">
        <span style="margin-right: 0.5em;">Balik Tampilan (180°):</span>
        <span class="toggle-switch">
      ...
      <label style="margin-top: 1.75rem;">Kecerahan: <span id="brightnessValue">10</span></label>
...
<label style="display: flex; align-items: center; justify-content: space-between; margin-top: 1rem;">
  <span style="margin-right: 0.5em;">Otomatis Meredup:</span>
  <span class="toggle-switch">
...
<div id="autoDimmingNote" class="small">
  Membutuhkan Kunci API OpenWeather yang valid dan lokasi untuk mendapatkan data matahari terbit/terbenam.
</div>


<label style="display: flex; align-items: center; justify-content: space-between; margin-top: 0.75rem;">
  <span style="margin-right: 0.5em;">Kustom Redup:</span>
  <span class="toggle-switch">
...
<input style="width: 100%;" type="range" min="-1" max="15"
  ...
  oninput="dimmingBrightnessValue.textContent = (this.value == -1 ? 'Off' : this.value);">
      ...
      <div class="form-group">
          <label style="display: flex; align-items: center; justify-content: space-between;">
              <span style="margin-right: 0.5em;">Aktifkan Hitung Mundur:</span>
              <span class="toggle-switch">
      ...
      <div class="form-group">
        <label style="display: flex; align-items: center; justify-content: space-between;">
          <span style="margin-right: 0.5em;">Hitung Mundur Dramatis:</span>
          <span class="toggle-switch">
  ...
  <input type="submit" class="primary-button" value="Simpan Pengaturan" />
</form>

<div class="footer">
  Project by: <a href="https://www.instagram.com/cupilstuff" target="_blank" rel="noopener noreferrer">Cupil Stuff</a><br>
  Durasi Menyala: <span id="uptimeDisplay">Memuat...</span>
</div>
...
window.onload = function () {
  ...
  .catch(err => {
    ...
    showSavingModal("");
    updateSavingModal("⚠️ Gagal memuat pengaturan.", false);
...
function ensureReloadButton(options = {}) {
  ...
  btn.textContent = options.text || "Muat Ulang Halaman";
